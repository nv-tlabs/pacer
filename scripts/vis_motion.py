...
from poselib.poselib.core.rotation3d import quat_from_rotation_matrix, quat_mul, quat_inverse
...
gender_beta = np.array([
    1.0000, -0.2141, -0.1140, 0.3848, 0.9583, 1.7619, 1.5040, 0.5765, 0.9636,
    0.2636, -0.4202, 0.5075, -0.7371, -2.6490, 0.0867, 1.4699, -1.1865
])
...
if masterfoot:
    ...
    _body_names = ['Pelvis', 'L_Hip', 'L_Knee', 'L_Ankle', 'L_Toe', 'L_Toe_1', 'L_Toe_1_1', 'L_Toe_2', 'R_Hip', 'R_Knee', 'R_Ankle', 'R_Toe', 'R_Toe_1', 'R_Toe_1_1', 'R_Toe_2', 'Torso', 'Spine', 'Chest', 'Neck', 'Head', 'L_Thorax', 'L_Shoulder', 'L_Elbow', 'L_Wrist', 'L_Hand', 'R_Thorax', 'R_Shoulder', 'R_Elbow', 'R_Wrist', 'R_Hand']
...
motion_lib = MotionLibSMPL(motion_file=motion_file,
...
if masterfoot:
    left_to_right_index = [
        7, 8, 9, 10, 11, 12, 13, 0, 1, 2, 3, 4, 5, 6, 14, 15, 16, 17, 18, 24,
...
while not gym.query_viewer_has_closed(viewer):
    ...
    dof_state = torch.stack([dof_pos, torch.zeros_like(dof_pos)], dim = -1).squeeze()
